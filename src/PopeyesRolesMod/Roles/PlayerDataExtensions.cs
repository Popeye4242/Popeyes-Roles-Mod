...
namespace PopeyesRolesMod
{
    public static class PlayerDataExtensions
    {
        ...
        {
            return PlayerDataManager.PlayerData[playerInfo.PlayerId].Role == role;
        }
        ...
        {
            return PlayerDataManager.ShieldedPlayer && PlayerDataManager.ShieldedPlayer.PlayerId == player.PlayerId;
        }


        public static PlayerData GetPlayerData(this PlayerControl player)
        {
            return PlayerDataManager.PlayerData[player.PlayerId];
        }
